...
for (let i = 0; i < scoresTwo.length; i++) {
    if (scoresTwo[i].score <= 60)
        scoresTwo[i].salaryIncrease = '0%'
    else if (scoresTwo[i].score <= 69)
        scoresTwo[i].salaryIncrease = '2%'
    else if (scoresTwo[i].score <= 89)
        scoresTwo[i].salaryIncrease = '3%'
    else if (scoresTwo[i].score <= 99)
        scoresTwo[i].salaryIncrease = '4%'
    else if (scoresTwo[i].score === 100)
        scoresTwo[i].salaryIncrease = '6%'
    else {
    }
}
